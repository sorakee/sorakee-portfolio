...
const Spaceship: React.FC<SpaceshipProps> = ({ props, onLoad }) => {
  ...
  return (
    <group {...props} dispose={null}>
      <pointLight intensity={10} decay={1} color="#65bcfc" position={[0, 2, 2.333]} />
      <pointLight intensity={10} decay={1} color="#65bcfc" position={[0, 2, 14.677]} />
      <pointLight intensity={10} decay={1} color="#6fcafc" position={[0, 2, 20.667]} />
